@extends('layouts.app')
@section('title', 'Nouvel Abonnement Membre')
...
<form action="{{ route('subscriptions.members.store') }}" method="POST" class="space-y-8">
  @csrf
...
async function loadSlots() {
  ...
  // Filter for Per-Visit logic (same as original)
