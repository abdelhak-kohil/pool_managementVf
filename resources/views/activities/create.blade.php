...
@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" x-data="{ color: '{{ old('color_code', '#3b82f6') }}' }">
    <!-- Header -->
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Nouvelle Activité</h1>
    ...
    <div class="max-w-3xl mx-auto">
        <form action="{{ route('activities.store') }}" method="POST" class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden relative">
            @csrf
            
            <div class="px-8 py-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                <h2 class="text-lg font-semibold text-gray-900">Information de l'activité</h2>
                <p class="text-sm text-gray-500 mt-1">Configurez les détails essentiels pour la nouvelle activité.</p>
            </div>
            ...
            <div class="p-8 space-y-8">
                ...
                <div>
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input type="text" name="access_type" id="access_type" value="{{ old('access_type') }}" required
                               class="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-lg py-2.5 transition ease-in-out duration-150"
